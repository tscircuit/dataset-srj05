...
const sampleUrl = new URL(
  "../sparkfun-boards/SparkFun-Air-Velocity-Sensor-Breakout-FS3000-1005/sample001_SparkFun-Air-Velocity-Sensor-Breakout-FS3000-1005.circuit.simple-route.json",
  import.meta.url,
)
const outputUrl = new URL("../docs/sample.svg", import.meta.url)
const sampleFile = await Bun.file(sampleUrl).json()
